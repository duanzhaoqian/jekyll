...
### 192.168.20.20所有请求转到192.168.10.10
...
或者
iptables -t nat -A POSTROUTING -d 192.168.10.10 -j SNAT --to 192.168.20.20
```

设置DNAT

```
iptables -t nat -A PREROUTING -d 192.168.20.20 -j DNAT --to 192.168.10.10
```